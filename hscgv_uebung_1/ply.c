...
)
{
  ...
  int swap = (file_type == PLY_BINARY_BE);
#else
  int swap = (file_type == PLY_BINARY_LE);
#endif

  assert(file_type == PLY_BINARY_LE || file_type == PLY_BINARY_BE);
